...
@Component({
  selector: 'app-staffing-home',
  templateUrl: './staffing-home.component.html',
  styleUrls: ['./staffing-home.component.scss']
})
export class StaffingHomeComponent implements OnInit, OnDestroy
{
